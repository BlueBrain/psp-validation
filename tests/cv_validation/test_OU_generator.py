...
def test_add_ou_noise():
    ...
    with patch('psp_validation.cv_validation.OU_generator.ou_generator') as patched:
        patched.return_value = noise
...
def test_ou_generator():
    ...
    expected = np.array([0., 0.030095, 0.018654, 0.008802, -0.011108, 0.004965,
                         -0.037694, -0.005234, -0.019318, -0.013339], dtype=np.float32)
